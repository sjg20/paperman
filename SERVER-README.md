...
**Query Parameters:**
- `q` (required) - Search pattern (case-insensitive substring match)
- `path` (optional) - Subdirectory to search in (relative to repository root)
...
**Query Parameters:**
- `path` (optional) - Directory to list (relative to repository root, default: root)
...
The server searches for and lists the following file types:
- `.max` - Paperman/Maxview native format
- `.pdf` - PDF documents
