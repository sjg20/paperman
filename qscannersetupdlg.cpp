...
{
  QGroupBox * deviceButtonGroup = new QGroupBox(this);
  ...
  qgl->addWidget(mpListView,1,1,0,1);
  ...
  deviceButtonGroup->setLayout(vbox);
  ...
  connect(mpListView,SIGNAL(doubleClicked(QListWidgetItem*)),
          this,SLOT(slotDeviceSelected(QListWidgetItem*)));
  connect(mpListView,SIGNAL(clicked(QListWidgetItem*)),
          this,SLOT(slotListViewClicked(QListWidgetItem*)));
...
/**  */
void QScannerSetupDlg::slotListViewClicked(QTreeWidgetItem*)
{
...
/**  */
void QScannerSetupDlg::slotDeviceSelected(QTreeWidgetItem*)
{
	slotDeviceSelected();
}
/**  */
