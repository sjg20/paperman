...
This guide will help you install and set up Claude Code (the AI coding assistant CLI) on your server.
...
If you want to use Claude on the server while working from your dev machine:
