...
..
   ...
   **Important:** Always test the server locally before deploying to
   production!
...
If you see a JSON response from the status endpoint, deployment is
complete.
...
..
   ...
   **Note:** Consider setting up log rotation for server.log to prevent
