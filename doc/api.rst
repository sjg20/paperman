...
- **Solution**: Ensure ``paperman`` binary is in the same directory as
``paperman-server``

**Problem**: Conversion times out - **Solution**: File may be too large
or complex. Try with a smaller file or increase timeout in source code.
