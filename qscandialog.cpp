...
//main layout
  ...
  mpInfoHBox = new QHBoxLayout(this);
...
//in drag mode, the user can type in the filename directly
  ...
  mpDragHBox1 = new QHBoxLayout(this);
...
//first button row
  mpButtonHBox1 = new QHBoxLayout(this);
...
//second button row
  mpButtonHBox2 = new QHBoxLayout(this);
